 ...
 * </NotSupported>
 */
exports.NotSupported = react_redux_1.connect(mapStateToProps)(class extends React.Component {
    render() {
 ...
 * </NotConnected>
 */
exports.NotConnected = react_redux_1.connect(mapStateToProps)(class extends React.Component {
    render() {
        const renderProps = {
            connectionState: this.props.connectionState
        };
