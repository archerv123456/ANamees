...
interface RoomDispatchProps {
    ...
    leave?: (roomAddress: string, endMedia?: boolean) => void;
...
declare const _default: import("react-redux").ConnectedComponent<typeof Room, Pick<React.ClassAttributes<Room> & RoomProps, "password" | "name" | "ref" | "children" | "key" | "render" | "excludeMedia" | "excludePeers" | "includeDeprecated" | "autoJoinCall"> & RoomProps>;
