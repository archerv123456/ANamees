        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (video) {
                ...
                if (this.props.screenCapture) {
                    this.props.addLocalScreen(video, stream, this.props.replaceVideo, (_b = this.props.videoName) !== null && _b !== void 0 ? _b : this.props.name);
                }
                else {
                    this.props.addLocalVideo(video, stream, this.props.mirrored, this.props.replaceVideo, (_c = this.props.videoName) !== null && _c !== void 0 ? _c : this.props.name);
                }
                if (this.props.share !== false) {
                    this.props.shareLocalMedia(video.id);
                }
